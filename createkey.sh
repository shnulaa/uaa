...
generateCert director 192.168.6.212 # <--- Replace with public Director IP
generateCert uaa-web 192.168.6.212  # <--- Replace with public Director IP
generateCert uaa-sp 192.168.6.212   # <--- Replace with public Director IP
